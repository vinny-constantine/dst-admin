...
//    public static final String START_CAVES_SHELL_NAME = "cave.sh";
    ...
    public static final String GAME_PATH = "~/Steam/steamapps/common/Don't Starve Together Dedicated Server/bin64";

    public static final String GAME_FILE = "./dontstarve_dedicated_server_nullrenderer_x64";

    /**
     * 启动地面进程命令 设置名称为 DST_MASTER
     */
    public static final String START_MASTER_CMD = String.format(
        "cd %s ; screen -S %s -p 0 -X stuff \"c_shutdown(true)\\n\" ; sleep 1 ; screen -X -S %s quit ; sleep 1 ; screen -d -m -S \"%s\"  %s -console -cluster" +
        " DST_1 -shard %s ;", GAME_PATH, SCREEN_WORK_MASTER_NAME, SCREEN_WORK_MASTER_NAME, SCREEN_WORK_MASTER_NAME, GAME_FILE, DST_MASTER);

    /**
     * 启动洞穴进程命令 设置名称为 DST_CAVES
     */
    public static final String START_CAVES_CMD = String.format("cd %s ; screen -S %s -p 0 -X stuff \"c_shutdown(true)\\n\" ; sleep 1 ; screen -X -S %s quit ;" +
                                                               " sleep 1 ;  screen -d -m -S \"%s\" %s -console -cluster DST_1 -shard %s ;", GAME_PATH,
        SCREEN_WORK_CAVES_NAME, SCREEN_WORK_CAVES_NAME, SCREEN_WORK_CAVES_NAME, GAME_FILE, DST_CAVES);
     ...
     * 删除地面游戏记录
     */
    public static final String DEL_RECORD_MASTER_CMD = "rm -r ~/.klei/DST_1/Cluster_1/" + DST_MASTER + "/save";

    /**
     * 删除地面游戏记录
     */
    public static final String DEL_RECORD_CAVES_CMD = "rm -r ~/.klei/DST_1/Cluster_1/" + DST_CAVES + "/save";

    /**
     * 获取地面的玩家 替换99999999关键字
     */
    public static final String MASTER_PLAYLIST_CMD = "screen -S \"" + SCREEN_WORK_MASTER_NAME +
                                                     "\" -p 0 -X stuff \"for i, v in ipairs(TheNet:GetClientTable()) do  print(string.format(\\\"playerlist " +
                                                     "%s [%d] %s %s %s\\\", 99999999, i-1, v.userid, v.name, v.prefab )) end$(printf \\\\r)\"\n";
     ...
     * 游戏文档
     */
    public static final String DST_DOC_PATH = ".klei/DST_1";

    /**
     * 饥荒游戏用户存档位置
     */
    public static final String DST_USER_GAME_CONFG_PATH = "/.klei/DST_1/Cluster_1";
     ...
     * 地上mod保存地址
     */
    public static final String DST_USER_GAME_MASTER_MOD_PATH = ".klei/DST_1/Cluster_1/" + DST_MASTER + "/modoverrides.lua";

    /**
     * 洞穴mod保存位置
     */
    public static final String DST_USER_GAME_CAVES_MOD_PATH = ".klei/DST_1/Cluster_1/" + DST_CAVES + "/modoverrides.lua";

    /**
     * 地面地图配置地址
     */
    public static final String DST_USER_GAME_MASTER_MAP_PATH = ".klei/DST_1/Cluster_1/" + DST_MASTER + "/leveldataoverride.lua";

    /**
     * 洞穴地图配置地址
     */
    public static final String DST_USER_GAME_CAVES_MAP_PATH = ".klei/DST_1/Cluster_1/" + DST_CAVES + "/leveldataoverride.lua";

    /**
     * 游戏配置文件
     */
    public static final String DST_USER_GAME_CONFIG_PATH = ".klei/DST_1/Cluster_1/cluster.ini";

    /**
     * 地面游戏运行日志位置
     */
    public static final String DST_MASTER_SERVER_LOG_PATH = ".klei/DST_1/Cluster_1/" + DST_MASTER + "/server_log.txt";

    /**
     * 地面用户聊天信息
     */
    public static final String DST_MASTER_SERVER_CHAT_LOG_PATH = ".klei/DST_1/Cluster_1/" + DST_MASTER + "/server_chat_log.txt";

    /**
     * 洞穴游戏运行日志位置
     */
    public static final String DST_CAVES_SERVER_LOG_PATH = ".klei/DST_1/Cluster_1/" + DST_CAVES + "/server_log.txt";

    /**
     * 管理员存储位置
     */
    public static final String DST_ADMIN_LIST_PATH = ".klei/DST_1/Cluster_1/adminlist.txt";

    /**
     * 黑名单存储位置
     */
    public static final String DST_PLAYER_BLOCK_LIST_PATH = ".klei/DST_1/Cluster_1/blocklist.txt";
